  ...
  perSystem =
    ...
    let
      ...
      fixtureEntries = [
        ...
        {
          url = "github:octocat/widget/issues/900025";
          description = "external-issue-linked-pr";
          message = null;
          targetChannel = "nixos-unstable";
        }
        {
          url = "github:octocat/widget/issues/900026";
          description = "external-issue-open-silent";
          message = null;
          targetChannel = "nixos-unstable";
        }
        {
      ...
      expectations = [
        ...
        "external-issue-linked-pr: upstream octocat/widget issue #900025 now has linked PR #900098"
